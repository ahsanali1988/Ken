...
/*
  ...
  Template Name: Acceptance Trainer Template

 */
get_header();
$current_user = wp_get_current_user();
$roles = $current_user->roles;
if ((is_user_logged_in()) && ($roles[0] == "trainer" )) {
if (isset($_REQUEST['form5']) && trim($_REQUEST['form5']) != "") {
        if (isset($_REQUEST['acceptLeader']) && trim($_REQUEST['acceptLeader']) != "") {
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="wpb_text_column wpb_content_element">
                    <div class="wpb_wrapper"><h3>Trainer Policy</h3></div>
                </div>
	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="form-group">
                                                    ...
                                                    <input type="checkbox" class="" required="" name="acceptLeader">
	                			</div>
	                		</div>
	                	</div>
                        <div class="form-group">
