...
if (isset($_REQUEST['user_name']) && trim($_REQUEST['user_name']) != "") {
    $bbb = array('role' => 'group_leader', 'search' => $_REQUEST['user_name'] . '*');
    $trainers = get_users(array('role' => 'mini_admin', 'search' => $_REQUEST['user_name'] . '*'));
} else {
    $trainers = get_users(array("role" => "mini_admin"));
}
//echo '<pre>';
...
<div class="eltdf-container eltdf-default-page-template">
    ...
    <div class="eltdf-container-inner clearfix">
        ...
        <div class="trainer_wrap">
                ...
                <form method="post" action="">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="btn_wrap">
                                <a class="btn_1" href="/add-mini-admin/">+ New Mini Admin</a>
            ...
            <!--                        <td>Edit</td>-->
                                    <td><a href="/mini-admin/?id=<?php echo $trainer->ID ?>" onclick="return confirm('Are you sure?')">Delete</a></td>
