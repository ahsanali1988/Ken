...
//                update_post_meta($id, 'group_leader_id', $user_id);
                ...
                update_user_meta($user_id, 'mini_admin_form', $_REQUEST);
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td valign="top" align="center" style="padding-bottom: 25px;padding-top: 25px;" >
                                                        <strong style="display:block;font-size:30px;">Mini Admin Details</strong>
                                                    </td>`
                                                </tr>
                                            </table>
                                        </td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <?php
                    if ($msg) {
                        echo '<strong class="f-sub-heading" style="text-align: center">Mini Admin added successfully!</strong>';
                    }
                    if ($error) {
                    ...
                    <div class="wpb_text_column wpb_content_element">
                        <div class="wpb_wrapper" style="text-align: center"><h3>Add Mini Admin</h3></div>
                    </div>
